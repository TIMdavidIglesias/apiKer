...
// const configSchema = new Schema<IApiAppsConfig>({
//   session: {
...
//   },
// }, { _id: false });
// export const apiAppsSchema: Schema = new Schema({
//   appID: { type: String, required: true },
//   isDefault: { type: Boolean, required: false },
//   appName: { type: String, required: true },
//   allowedOrigin: { type: String, required: true },
...
//       livesessionExpirySecs: { type: Number, required: true },
//     }, required: true
//   },
//   adminEmail: { type: String, required: true },
//   applicationSecretToken: { type: String, required: true },
...
//       policy: {
//         onExpiredToken: { type: String, required: true },
//         tokenReception: { type: String, required: true },
//       }
//     },
//     signup: {
//       accountTypeDefaultID: { type: Number, required: true },
